...
//           </Typography>
//           <img
//             src="/assets/logos/yuvalogo (1).png"
//             alt=""
//             style={{
//               maxWidth: "200px",
//               height: "auto",
...
import NextLink from "next/link";
import PropTypes from "prop-types";
import { Box, Stack, Typography, ImageListTile, ListSubheader } from "@mui/material";
import { Logo } from "../../components/logo";
import { paths } from "../../paths";
  ...
  return (
    <Box
      sx={{
        ...
        flex: "1 1 auto",
        flexDirection: {
          xs: "column-reverse", // Reversing the order for small screens
          md: "row",
        },
      }}
    >
