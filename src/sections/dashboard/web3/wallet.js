...
const web3 = new Web3(
  Web3.givenProvider ||
    "https://mainnet.infura.io/v3/3840775933b94a0ca2cc13fa742a2b43"
);

export const YB_TESTNET_CONTRACT_ADDRESS =
  "0x32B02EFf8d5bFd15C19e2d6573Ad97d0756Ab71f";
export const YBabi = [
  {
    inputs: [
...
export const YBCONTRACT = new web3.eth.Contract(
  YBabi,
  YB_TESTNET_CONTRACT_ADDRESS
);

// export const YUVABITCOIN_ABI =

export const BUSD_TESTNET_CONTRACT_ADDRESS =
