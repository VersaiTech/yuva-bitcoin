...
const { register, login, getRegister, adminRegister, adminLogin, verifyOTP, forgotPassword, getAllAgent, verifyOTPForResetPassword, changePassword, verifyOTPAdmin } = require('../controllers/Auth.controller');
