...
router.route('/countMembersWithCoins').get(isAdmin, countMembersWithCoins);
router.route('/countMemberWithStakeCoins').get(isAdmin, countMemberWithStakeCoins);
